...
export const officialCountries: Country[] = [
...
export const officialCountriesWithImage = officialCountries.filter((c) =>
  countryCodesWithImage.includes(c.code.toLowerCase())
);
...
export const bigEnoughOfficialCountriesWithImage =
  officialCountriesWithImage.filter(
    (country) => areas[country.code] > smallCountryLimit
  );
